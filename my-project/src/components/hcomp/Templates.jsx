...
const Templates = () => {
  return (
    <div className="pt-[100px] bg-[#F9EFE4] w-[100%] h-[100%] ">
        ...
        className={"text-[black] border-2 border-black rounded-full p-[20px]  w-[250px]  h-[60px] mt-8  ml-[35rem]   "} />

    <div className=" mt-[20px] md:mt-[100px]"> 
    <div className=" flex flex-col justify-center md:grid grid-cols-6 gap-20 ">
        <div className="flex flex-col gap-2 pl-[20px] pt-2 rounded-md bg-white h-[150px] w-[150px]" >
        ...
        <div className="border-3 h-[150px] w-[150px] bg-white">
